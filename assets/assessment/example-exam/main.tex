...
\]
        ...
        State and justify which pairs of strategies are best responses to each
            ...
            \begin{enumerate}
                ...
                \item \(\sigma_r=(5/9, 4/9)\) and \(\sigma_c=(1/2, 1/2)\)
            \end{enumerate}
            ~\hfill{[9]}
...
$$
            ...
            Prove that the Shapley value satisfies the symmetry property.
...
\item
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Explain whether the collective preference relation using this
                approach is transitive.
        \end{enumerate}
