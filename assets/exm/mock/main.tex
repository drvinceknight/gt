...
\item
    ...
    \begin{enumerate}
        ...
        \item Give the definition for the Lemke-Howson algorithm.
            ~\hfill{[5]}
        \item Show that the vertices for the best response polytopes are given
            by:
            \begin{center}
                OBTAIN P AND Q
            \end{center}
        ...
        \item Use the plots to carry out the Lemke-Howson algorithm with all
            ...
            ~\hfill{[4]}
        \item Use the pair of vertices found in the previous question and find
            an initial dropped label that gives a different Nash equilibrium
            than the one obtained in the previous question.
            ~\hfill{[1]}
