...
1. [Best Response condition](https://vknight.org/gtb/chapters/rationalisation/) and
   proof.
2. [Existence of Nash equilibrium in games of perfect information](https://vknight.org/gtb/chapters/subgame-perfection/) and proof.
3. [Subgame perfection of sequence of stage Nash equilibrium](https://vknight.org/gtb/chapters/repeated-games/) and proof.
4. [Folk Theorem](https://vknight.org/gtb/chapters/repeated-games/) and
   proof.
5. [Characterisation of ESS in two player games](https://vknight.org/gtb/chapters/replicator-dynamics/) and proof.
6. [The fixation probabilities in populations of two types](https://vknight.org/gtb/chapters/moran-process/) and proof.
7. [Nash Flow minimises the potential function](https://vknight.org/gtb/chapters/routing-games/)
8. [Optimal Flow is a Nash Flow for Marginal Costs](https://vknight.org/gtb/chapters/routing-games/)
9. [Unique matching as output of the Gale Shapley algorithm](https://vknight.org/gtb/chapters/matching-games/) and proof.
10. [Reviewer sub optimality of the Gale Shapley Algorithm](https://vknight.org/gtb/chapters/matching-games/) and proof.
11. [Bayesian Nash Equilibrium for Second Pay Auction](https://vknight.org/gtb/chapters/auction-games/) and proof.
12. [Bayesian Nash equilibrium in a first-price auction with uniform values](https://vknight.org/gtb/chapters/auction-games/) and proof.
13. [Arrow’s Impossibility Theorem](https://vknight.org/gtb/chapters/social-choice/)
