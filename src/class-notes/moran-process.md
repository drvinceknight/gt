...
**Goal.** Reproduce a Moran process by hand so the birth-death dynamics and
fixation are felt before they are formalised. This activity is deliberately
longer than the usual 20 minutes.

Use [moran process form](/assets/activities/moran_process/main.pdf) and have
...
![](/assets/activities/moran_process/moran_process.png)
